...
export default function AdminDashboard() {
  ...
  const [stats, setStats] = useState([
    ...
    { label: 'Growth Rate', value: '0%', icon: TrendingUp, color: 'text-indigo-600', bgColor: 'bg-indigo-50', trend: '0%' },
  ]);
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      setStats([
        { label: 'Total Applicants', value: total.toLocaleString(), icon: Users, color: 'text-blue-600', bgColor: 'bg-blue-50', trend: '+100%' },
        { label: 'Verified Payments', value: verified.toLocaleString(), icon: CreditCard, color: 'text-emerald-600', bgColor: 'bg-emerald-50', trend: 'Success' },
        { label: 'High Score (90+)', value: highScorers.toLocaleString(), icon: CheckCircle, color: 'text-amber-600', bgColor: 'bg-amber-50', trend: 'Top Tier' },
        { label: 'Live Status', value: 'Active', icon: TrendingUp, color: 'text-indigo-600', bgColor: 'bg-indigo-50', trend: 'Live' },
      ]);
